  ...
  async function handlePrint() {
    ...
    win.document.write(`
      ...
      <style>
        ...
        * { margin:0; padding:0; }
        body{font-family:Georgia,serif;color:#333;max-width:700px;margin:auto;padding:20px;position:relative}
        body::before{content:'';position:fixed;top:50%;left:50%;transform:translate(-50%,-50%) rotate(-45deg);width:1200px;height:1200px;background-image:url('${logoB64}');background-repeat:no-repeat;background-position:center;background-size:800px 800px;opacity:0.12;pointer-events:none;z-index:0;print-color-adjust:exact;-webkit-print-color-adjust:exact}
        ...
        @media print{body::before{opacity:0.12!important;print-color-adjust:exact!important;-webkit-print-color-adjust:exact!important}}
      </style></head><body>
